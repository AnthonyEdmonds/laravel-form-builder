...
class PreviousItemTest extends TestCase
{
    ...
    {
        $this->redirect = $this->tasks->previousItem('next-task');

        $this->assertEquals(
            $this->tasks->task('my-task')->route(),
    ...
    {
        $this->redirect = $this->tasks->previousItem('my-task');
